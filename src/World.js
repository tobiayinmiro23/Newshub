...
const World = () => {
    ...
    const handleSearch=(e)=>{
        setnoResult(false)
        setsearching(true)
        fetch(`https://newsdata.io/api/1/news?apikey=pub_210660b996e06920b7f144ea9530f2b020ef9&category=world&country=${country}&page=${page}`)
            .then(res=>res.json())
            .then(res=>{
                console.log(res)
        ...
        return (
            <div className='Business'>
                <h1 style={{borderBottom:'1px solid #d5d4d4',padding:"0.8rem",textAlign:"center"}}>World</h1>
